package com.Dashboard.reception.showAllEmployee;
...
public class showAllEmp extends JFrame implements ActionListener {
	JTable table;
	JButton back;
	private static final long serialVersionUID = 1L;
	public showAllEmp() {
		super("Show Employees");//Add title of the Page
		...
		add(table);
		table.setModel(DbUtils.resultSetToTableModel(new EmpDao().allShowEmployee()));
